...
test("group-content isInView clip - fully in view", () => {
  expect(
    projectWith1Clip(20, 80).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - align with start", () => {
  expect(
    projectWith1Clip(20, 81).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - align with end", () => {
  expect(
    projectWith1Clip(19, 81).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - not fully in view", () => {
  expect(
    projectWith1Clip(25, 70).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - at the start of the view", () => {
  expect(
    projectWith1Clip(15, 6).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - not at the start of the view", () => {
  expect(
    projectWith1Clip(15, 5).content.content[0].isInView(0, 20, 100)
  ).toBeFalsy()
})

test("group-content isInView clip - at the end of the view", () => {
  expect(
    projectWith1Clip(99, 6).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})

test("group-content isInView clip - not at the end of the view", () => {
  expect(
    projectWith1Clip(100, 5).content.content[0].isInView(0, 20, 100)
  ).toBeFalsy()
})

test("group-content isInView clip - not at all in view", () => {
  expect(
    projectWith1Clip(200, 5).content.content[0].isInView(0, 20, 100)
  ).toBeFalsy()
})

test("group-content isInView clip - larger than view", () => {
  expect(
    projectWith1Clip(0, 200).content.content[0].isInView(0, 20, 100)
  ).toBeTruthy()
})
...
test("group-content isInView group - fully in view", () => {
  expect(complexProject().content.content[0].isInView(0, 10, 50)).toBeTruthy()
})

test("group-content isInView group - align with start", () => {
  expect(complexProject().content.content[0].isInView(0, 10, 49)).toBeTruthy()
})

test("group-content isInView group - align with end", () => {
  expect(complexProject().content.content[0].isInView(0, 20, 50)).toBeTruthy()
})

test("group-content isInView group - not fully in view", () => {
  expect(complexProject().content.content[0].isInView(0, 5, 55)).toBeTruthy()
})

test("group-content isInView group - at the start of the view", () => {
  expect(complexProject().content.content[0].isInView(0, 5, 15)).toBeTruthy()
})

test("group-content isInView group - not at the start of the view", () => {
  expect(complexProject().content.content[0].isInView(0, 50, 100)).toBeFalsy()
})

test("group-content isInView group - at the end of the view", () => {
  expect(complexProject().content.content[0].isInView(0, 49, 100)).toBeTruthy()
})

test("group-content isInView group - not at the end of the view", () => {
  expect(complexProject().content.content[0].isInView(0, 2, 10)).toBeFalsy()
})

test("group-content isInView group - not at all in view", () => {
  expect(complexProject().content.content[0].isInView(0, 60, 100)).toBeFalsy()
})

test("group-content isInView group - larger than view", () => {
  expect(complexProject().content.content[0].isInView(0, 20, 30)).toBeTruthy()
})
